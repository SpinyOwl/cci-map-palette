...
Gradle-driven project for building an FTB Chunks support resource pack. The current pack adds map colors for blocks from Chisel Chipped Integration, XTones Reworked, XyCraft: World, GregTech CEu Modern, Simply Light, and Applied Energistics 2.
